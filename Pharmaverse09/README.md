...
| # | Lesson | Package(s) |
|---|---|---|
| 45 | `{logrx}` — execution logging | `logrx` |
| 46 | `{diffdf}` — dataset comparison for dual programming | `diffdf` |
| 47 | `{riskmetric}` — assessing package risk for regulated use | `riskmetric` |

### Capstone (`99_capstone/`)

| # | Lesson | What you'll do |
|---|---|---|
| 48 | End-to-end walkthrough | Build a complete deliverable for a synthetic oncology study: raw EDC → SDTM → ADaM → ARDs → demographics + AE + KM table → teal app → XPT for submission |
...
| 9 — Submission | Pending (Batch 10) |
| 10 — Traceability | Pending (Batch 10) |
| 99 — Capstone | Pending (Batch 10) |
